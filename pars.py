...
def gpupricing(desiredprice):
    ...
    for price in pricerange:
        ...
        strongtag = parent.find("strong") #radgan "$" <strong>$</strong> formit gvxvdeba, parentshi unda vipovot strong tagi
    ...
    return acceptable
print(gpupricing(1500)) #daabrunebs masivs romelic sheicavs yvela 1500is an naklebi dolaris fasis mqone leptops
